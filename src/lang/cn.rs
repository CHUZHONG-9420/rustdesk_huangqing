...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("starts with a letter", "以大写字母或数字开头"),
        ("allowed characters", "仅允许大写字母、数字、- 和 _"),
        ("id_change_tip", "只可以使用大写字母 A-Z、数字 0-9、- 和 _。首字符必须是大写字母或数字。长度在 6 与 16 之间。"),
        ("Website", "网站"),
        ("About", "关于"),
        ...
        ("Set Password", "设置密码"),
        ("OS Password", "操作系统密码"),
        ("install_tip", "你正在运行未安装版本，由于 UAC 限制，作为被控端，会在某些情况下无法控制鼠标键盘，或者录制屏幕，请点击下面的按钮将本软件安装到系统，从而规避上述问题。"),
        ("Click to upgrade", "点击这里升级"),
        ("Configure", "配置"),
        ("config_acc", "为了能够远程控制你的桌面, 请给予本软件 \"辅助功能\" 权限。"),
        ("config_screen", "为了能够远程访问你的桌面, 请给予本软件 \"屏幕录制\" 权限。"),
        ("Installing ...", "安装中..."),
        ("Install", "安装"),
        ("Installation", "安装"),
        ...
        ("android_input_permission_tip1", "为了让远程设备通过鼠标或触屏控制您的安卓设备，你需要允许本软件使用\"无障碍\"服务。"),
        ...
        ("Turned off", "退出"),
        ("Language", "语言"),
        ("Keep RustDesk background service", "保持远程控制后台服务"),
        ("Ignore Battery Optimizations", "忽略电池优化"),
        ("android_open_battery_optimizations_tip", "如需关闭此功能，请在接下来的本软件应用设置页面中，找到并进入 [电源] 页面，取消勾选 [不受限制]"),
        ("Start on boot", "开机自启动"),
        ...
        ("Show RustDesk", "显示远程控制"),
        ("This PC", "此电脑"),
        ("or", "或"),
        ("Elevate", "提权"),
        ("Zoom cursor", "缩放光标"),
        ("Accept sessions via password", "只允许密码访问"),
        ("Accept sessions without password", "无密码直接连接"),
        ...
        ("config_input", "为了能够通过键盘控制远程桌面, 请给予本软件 \"输入监控\" 权限。"),
        ("config_microphone", "为了支持通过麦克风进行音频传输，请给予本软件 \"录音\"权限。"),
        ...
        ("still_click_uac_tip", "依然需要被控端用户在运行本软件的 UAC 窗口点击确认。"),
        ...
        ("verify_rustdesk_password_tip", "验证远程控制密码"),
        ...
        ("{} sessions", "{} 个会话"),
        ("scam_title", "你可能被骗了！"),
        ("scam_text1", "如果你正在和素不相识的人通话，而对方要求你使用本软件启动服务，请勿继续操作并立刻挂断电话。"),
        ...
        ("selinux_tip", "SELinux 处于启用状态，本软件可能无法作为被控正常运行。"),
        ("Change view", "更改视图"),
        ("Big tiles", "大磁贴"),
        ("Small tiles", "小磁贴"),
        ("List", "列表"),
        ...
        ("allow-only-conn-window-open-tip", "仅当本软件窗口打开时允许连接"),
