...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Connecting to the remote control network..."),
        ("not_ready_status", "Not ready. Please check your connection"),
        ("ID/Relay Server", "ID/Relay server"),
        ("id_change_tip", "Only uppercase letters A-Z, digits 0-9, - (dash) and _ (underscore) are allowed. Must start with an uppercase letter or digit. Length between 6 and 16."),
        ...
        ("install_tip", "Due to UAC, the application can not work properly as the remote side in some cases. To avoid UAC, please click the button below to install the application to the system."),
        ("config_acc", "In order to control your Desktop remotely, you need to grant the application \"Accessibility\" permissions."),
        ("config_screen", "In order to access your Desktop remotely, you need to grant the application \"Screen Recording\" permissions."),
        ...
        ("android_input_permission_tip1", "In order for a remote device to control your Android device via mouse or touch, you need to allow the application to use the \"Accessibility\" service."),
        ("android_input_permission_tip2", "Please go to the next system settings page, find and enter [Installed Services], turn on [Remote Control Input] service."),
        ...
        ("android_open_battery_optimizations_tip", "If you want to disable this feature, please go to the next application settings page, find and enter [Battery], Uncheck [Unrestricted]"),
        ...
        ("config_input", "In order to control remote desktop with keyboard, you need to grant the application \"Input Monitoring\" permissions."),
        ("config_microphone", "In order to speak remotely, you need to grant the application \"Record Audio\" permissions."),
        ...
        ("still_click_uac_tip", "Still requires the remote user to click OK on the UAC window of the running application."),
        ...
        ("verify_rustdesk_password_tip", "Verify remote control password"),
        ...
        ("scam_text1", "If you are on the phone with someone you DON'T know AND TRUST who has asked you to use this application and start the service, do not proceed and hang up immediately."),
        ...
        ("selinux_tip", "SELinux is enabled on your device, which may prevent the application from running properly as controlled side."),
        ...
        ("powered_by_me", "Powered by Remote Control"),
        ...
        ("allow-only-conn-window-open-tip", "Only allow connection if the application window is open"),
        ...
        ("floating_window_tip", "It helps to keep the application background service"),
        ...
        ("About RustDesk", "About"),
        ("starts with a letter", "starts with uppercase letter or digit"),
        ("allowed characters", "only uppercase letters, digits, - and _"),
        ("no simple pattern", "no simple pattern"),
        ("Accept sessions without password", "Accept sessions without password"),
